  ...
  return (
    <div className="App">
      <div className='contenedor-principal'>
        ...
        testimonio='In the bustling neighborhood of Purrington, whiskered entrepreneur Jey decided to pursue a culinary dream: owning the finest cat-friendly restaurant in town! With a flair for flavor and a charismatic purr-suasion, Jey convinced fellow felines to dine at his establishment. Soon, the restaurant gained a loyal following, expanding to other corners of the city. Cats flocked to savor the gourmet dishes crafted with love and care. Jey not only mastered the art of feline gastronomy but also became a symbol of culinary success, inspiring aspiring cat chefs everywhere. His restaurant became a global sensation, and Jey purred contentedly at the success of his whisker-licking venture!' />
        <Testimonio
